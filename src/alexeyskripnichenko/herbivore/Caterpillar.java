...
public class Caterpillar extends Herbivors {


    public Caterpillar(String name, String icon, double startWeigth, double maxWeigth, double minWeigth, int maxValue, int speed, double maxFood) {
